...
// rebuild tabel sample MP4 dan menambahkan sample video 8-byte.
...
if (patchBtn) {
  patchBtn.addEventListener('click', async () => {
    ...
    appendLog('Kecap Manis: rebuilding MP4 sample tables...');
    ...
    try {
      ...
      a.href = url;
      a.download = `${originalName}_KECAP_OJEEH.mp4`;
